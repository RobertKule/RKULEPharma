...
?>
    <div class="container bg-body">
        ...
        <div class="mx-auto">  
            ...
            <form action="" method="post" class="mx-md-5 mt-5 mb-2 p-5 form-horizontal text-dark bg-light shadow-lg">
                ...
                // je déclare les variables
                    ...
                    header('location:login.php?message="Enregistrement réussi !!!"');        
                    }          
                ...
                <div class="row ">
                    <div class="btn-group-justified offset-md-4 mt-4 col-md-4">
                        <input type="submit" required class="btn btn-dark form-control" value="Enregistrer" name="btenregistrer">
                    </div>
                </div>
                <div class="form-control btn btn-default">
                    Vous avez un compte?<a href="login.php" class="btn btn-link ">connectez-vous</a>
                </div>
            </form>
        </div>
